...
{
    /// <summary>
    /// Interaction logic for RecWinPView.xaml
    /// </summary>
    public partial class RecWinPView : Window
    {
        private RecWinP recWinP;
        ...
        private void OkButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            recWinP = new RecWinP(xStart, yStart, xLenght, yLenght, overlap, tool, false);
